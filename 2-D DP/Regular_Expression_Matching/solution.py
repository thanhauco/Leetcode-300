...
class Solution:
    def solve_regular_expression_matching(self, nums: List[int]) -> int:
        """
...
# Example usage:
# sol = Solution()
# print(sol.solve_regular_expression_matching([1, 2, 3]))
