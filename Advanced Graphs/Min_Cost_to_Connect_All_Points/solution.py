...
class Solution:
    def solve_min_cost_to_connect_all_points(self, nums: List[int]) -> int:
        """
        Solves the Min Cost to Connect All Points problem.
...
# Example usage:
# sol = Solution()
# print(sol.solve_min_cost_to_connect_all_points([1, 2, 3]))
