...
class Solution:
    def solve_letter_combinations_of_a_phone_number(self, nums: List[int]) -> int:
        """
        Solves the Letter Combinations of a Phone Number problem.
...
# Example usage:
# sol = Solution()
# print(sol.solve_letter_combinations_of_a_phone_number([1, 2, 3]))
