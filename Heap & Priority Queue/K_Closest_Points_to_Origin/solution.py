...
class Solution:
    def solve_k_closest_points_to_origin(self, nums: List[int]) -> int:
        """
        Solves the K Closest Points to Origin problem.
...
# Example usage:
# sol = Solution()
# print(sol.solve_k_closest_points_to_origin([1, 2, 3]))
