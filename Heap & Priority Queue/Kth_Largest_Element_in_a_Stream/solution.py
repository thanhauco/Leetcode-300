...
class Solution:
    def solve_kth_largest_element_in_a_stream(self, nums: List[int]) -> int:
        """
        Solves the Kth Largest Element in a Stream problem.
...
# Example usage:
# sol = Solution()
# print(sol.solve_kth_largest_element_in_a_stream([1, 2, 3]))
