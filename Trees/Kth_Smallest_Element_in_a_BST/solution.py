...
class Solution:
    def solve_kth_smallest_element_in_a_bst(self, nums: List[int]) -> int:
        """
        Solves the Kth Smallest Element in a BST problem.
...
# Example usage:
# sol = Solution()
# print(sol.solve_kth_smallest_element_in_a_bst([1, 2, 3]))
