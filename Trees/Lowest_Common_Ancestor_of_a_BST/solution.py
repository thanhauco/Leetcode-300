...
class Solution:
    def solve_lowest_common_ancestor_of_a_bst(self, nums: List[int]) -> int:
        """
        Solves the Lowest Common Ancestor of a BST problem.
...
# Example usage:
# sol = Solution()
# print(sol.solve_lowest_common_ancestor_of_a_bst([1, 2, 3]))
