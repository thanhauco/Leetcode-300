...
class Solution:
    def solve_validate_binary_search_tree(self, nums: List[int]) -> int:
        """
        Solves the Validate Binary Search Tree problem.
...
# Example usage:
# sol = Solution()
# print(sol.solve_validate_binary_search_tree([1, 2, 3]))
